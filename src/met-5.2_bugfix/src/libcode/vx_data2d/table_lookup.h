...
public:
  // _bp_ public
  //      int get_table_files(const char *dir, const char *prefix, const char *postfix, vector<ConcatString> &a);
     ...
     int N_grib2_alloc;
      ...
      TableFlatFile();
      TableFlatFile(int, char *table_data_dir);   //  reads defaults
     ~TableFlatFile();
      ...
      // _bp_ void readUserGribTables(const char * table_type);
...
// _bp_ extern TableFlatFile GribTable;
